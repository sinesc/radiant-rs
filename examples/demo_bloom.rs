...
pub fn main() {
    ...
    let sprite = Sprite::from_file(&context, r"res/battery_lightmapped_128x128x15x2.png").unwrap();
    ...
    utils::renderloop(|state| {
        ...
        // Clear frame, draw unprocessed layers and postprocessed lightmap layer.
