// Bloom combine — combines 5 progressively scaled textures
// Self-contained shader: bindings declared here, no preamble injection.
// Brightness is passed via program.set_uniform("brightness", &value),
// which the engine maps to texture_uniforms._rd_flags.y automatically.
